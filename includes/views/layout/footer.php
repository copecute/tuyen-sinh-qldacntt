                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        ...
                        <div class="widget-call">
                            ...
                            <a href="tel:0888889530">088 888 9530</a>
                        </div><!-- End .widget-call -->
                                    ...
                                    <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                        ...
                                        <div class="form-footer">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="signin-remember">Lưu đăng
                                                    nhập</label>
                                        ...
                                        <div class="form-footer">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="register-policy"
                                                    required>
                                                <label class="custom-control-label" for="register-policy">Đồng ý với <a
                                                        href="#">điều khoảng</a> của chúng tôi *</label>
                                            </div><!-- End .custom-checkbox -->
                                        </div><!-- End .form-footer -->
                                    </form>
                                    <div class="form-choice">
