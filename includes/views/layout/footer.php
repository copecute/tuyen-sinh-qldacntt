            ...
            <div class="col-lg-12">
                <div class="call-to-sction bg_image shape-move">
                    ...
                    <div class="shape-image">
                        <div class="shape one" data-speed="0.04"><img src="/resources/images/cta/03.svg" alt=""></div>
                        <div class="shape two" data-speed="0.04"><img src="/resources/images/cta/04.svg" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
...
<!-- metismenu js -->
<script src="/resources/js/vendor/metismenu.js"></script>
<!-- magnific popup js-->
<script src="/resources/js/vendor/magnifying-popup.js"></script>
<!-- swiper JS 10.2.0 -->
<script src="/resources/js/plugins/swiper.js"></script>
<!-- counterup js -->
<script src="/resources/js/plugins/counterup.js"></script>
<!-- waypoint js -->
<script src="/resources/js/vendor/waypoint.js"></script>
<!-- wow js -->
<script src="/resources/js/vendor/waw.js"></script>
<!-- isotop mesonary -->
<script src="/resources/js/plugins/isotop.js"></script>
<!-- jquery imageloaded -->
<script src="/resources/js/plugins/imagesloaded.pkgd.min.js"></script>
<!-- resize sensor js -->
<script src="/resources/js/plugins/resizer-sensor.js"></script>
<!-- sticky sidebar -->
<script src="/resources/js/plugins/sticky-sidebar.js"></script>
<!-- gsap twinmax js -->
<script src="/resources/js/plugins/twinmax.js"></script>
<!-- chroma js -->
<script src="/resources/js/vendor/chroma.min.js"></script>
<!-- bootstrap 5.0.2 -->
<script src="/resources/js/plugins/bootstrap.min.js"></script>
<!-- dymanic Contact Form -->
<script src="/resources/js/plugins/contact.form.js"></script>
<!-- calender js -->
<script src="/resources/js/plugins/calender.js"></script>
<!-- main Js -->
