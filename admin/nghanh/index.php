...
renderHeader("Quản lý nghành");

// Check if khoa_id is provided in the URL
$khoa_id = isset($_GET['khoa']) ? $_GET['khoa'] : '';
...
<div class="container mt-5">
    ...
    <div class="row mb-3">
        <div class="col">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addNghanhModal"
                data-action="add">Thêm Nghành</button>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <select class="form-control" id="khoaFilter">
                ...
                foreach ($khoas as $khoa) {
                    $selected = ($khoa_id == $khoa['id']) ? 'selected' : '';
                    echo '<option value="' . $khoa['id'] . '" ' . $selected . '>' . $khoa['ten_khoa'] . '</option>';
                }
                ?>
            </select>
        </div>
...
<!-- Add Nghành Modal -->
<div class="modal fade" id="addNghanhModal" tabindex="-1" role="dialog" aria-labelledby="addNghanhModalLabel"
    aria-hidden="true">
...
<!-- Edit Nghành Modal -->
<div class="modal fade" id="editNghanhModal" tabindex="-1" role="dialog" aria-labelledby="editNghanhModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.pagination a.page-link', function (e) {
            ...
            var khoa_id = $('#khoaFilter').val();
            loadNghanh(khoa_id, page);
        });
        ...
        function loadNghanh(khoa_id, page) {
            $.ajax({
                url: "/admin/nghanh/fetch.php",
                type: "POST",
                data: {
